...
- Prevent the Windows release workflow from running the workstation-only `D:\PhD\AI大赛\codex_neuroephys_ai` archive refresh on a detached GitHub Actions checkout.
