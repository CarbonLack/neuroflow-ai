...
| [scikit-learn grouped cross-validation](https://scikit-learn.org/stable/modules/cross_validation.html#cross-validation-iterators-for-grouped-data) | GroupKFold, StratifiedGroupKFold and LeaveOneGroupOut definitions | Study-level animal/session holdout, fold-local scaling, within-session permutation and held-out-group uncertainty |
| [scikit-learn LDA](https://scikit-learn.org/stable/modules/lda_qda.html) | Supervised linear discriminant analysis and shrinkage covariance | Registered Study classifier kept distinct from latent dynamics |
| [statsmodels MixedLM](https://www.statsmodels.org/stable/mixed_linear.html) | Linear mixed-effects API and random-effects structure | Conservative animal random intercept and session variance-component summary, withheld for very small animal counts |
| [Yu et al. 2009 GPFA](https://doi.org/10.1152/jn.90941.2008) and [Cunningham & Yu 2014](https://doi.org/10.1038/nn.3776) | Population latent-variable analysis and dimensionality-reduction context | Transparent descriptive PCA plus ridge-regularized linear transition model; no GPFA/deep-generative claim |
