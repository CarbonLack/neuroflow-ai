...
NeuroFlow figures are live Matplotlib canvases rather than screenshots.
...
- Use the presentation selector to emphasize data points, convert lines to step
  display, or apply grayscale/high-contrast styling.
- Exported SVG remains editable in Illustrator, Inkscape, or compatible software.
