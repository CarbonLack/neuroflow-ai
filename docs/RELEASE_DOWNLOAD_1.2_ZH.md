...
v1.2.6 源码回归 155 项通过。此前版本已分别检查 Full、Full 仅核心、标准安装版和标准便携版的启动、离线 AI 确认保护及 SVG/PDF/PNG 导出；这些历史检查不等同于每个新版本都重新完成四种安装组合。各版本实际验收范围以[完整验证记录](https://github.com/CarbonLack/neuroflow-ai/blob/main/RELEASE_VALIDATION_1.2.md)为准。本机 Full 使用教学数据实际运行 Kilosort 4、MountainSort5、SpyKING CIRCUS 2、Tridesclous 2、Simple、Lupin，并保存比较结果。
