# NeuroEphys AI 1.0 — 首次使用 / First read

## Windows 普通用户

1. 推荐运行 `NeuroEphysAI-Setup-1.0.0.exe`，安装过程不需要管理员权限。
...
首次启动可先选择“教学模拟”，确认界面、图表和导出都能工作。Sorter 管理页显示当前
...
Run `NeuroEphysAI-Setup-1.0.0.exe`, then open **NeuroEphys AI** from the desktop
